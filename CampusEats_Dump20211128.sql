DROP DATABASE `CampusEats_Fall_2021`;
...
INSERT INTO `driver` VALUES (1,'1999-03-11','6996164',1),(2,'2010-11-02','6244114',2),(3,'2011-04-21','113654424',3),(4,'2020-12-10','B13654424',4),(5,'2017-05-11','999000680',5),(6,'2001-03-12','A0002144',6),(7,'2014-07-12','94-33-0101',7),(8,'2000-02-09','146825129',8),(9,'2012-03-22','1232805',9),(10,'2011-08-15','G544061739250',10);
...
CREATE TABLE `rating` (
  ...
  KEY `FKj9037d2patnmrrx9qicig3kah` (`driver_id`),
  KEY `FK6ua65pahviqj3c3hoeg0k3u7j` (`item_id`),
  KEY `FKgbo4sj6hljui2lqf4m7t2k2c` (`restaurant_id`),
  CONSTRAINT `FK6ua65pahviqj3c3hoeg0k3u7j` FOREIGN KEY (`item_id`) REFERENCES `items` (`item_id`),
  CONSTRAINT `FKgbo4sj6hljui2lqf4m7t2k2c` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurant` (`restaurant_id`),
  CONSTRAINT `FKj9037d2patnmrrx9qicig3kah` FOREIGN KEY (`driver_id`) REFERENCES `driver` (`driver_id`)
...
INSERT INTO `rating` VALUES (1,'The food  is good.',4,4.8,'/var/etc/campuseats/photo.png',NULL,3,37,7),(2,'I like it',4,4.5,NULL,4.8,3,53,9),(3,NULL,4.5,4.8,'/var/etc/campuseats/photo1.png',4.8,7,32,6),(4,'Great service',4.5,4.8,NULL,4.8,7,33,6),(5,NULL,4.5,4.7,'/var/etc/campuseats/photo2.png',4.5,4,7,2),(6,'Love it.',4.8,4.8,NULL,4.8,2,32,7),(7,'very good',4.6,4.9,'/var/etc/campuseats/photo5.png',4.9,5,17,3);
...
--
-- Dumping events for database 'dumptest_2'
--
...
-- Dump completed on 2021-11-28 15:47:42
